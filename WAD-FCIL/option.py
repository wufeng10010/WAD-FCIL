...
def args_parser():
    ...
    parser.add_argument('--method', type=str, default='WAD', help="name of method")
    parser.add_argument('--iid_level', type=int, default=6, help='number of data classes for local clients')
    parser.add_argument('--numclass', type=int, default=5, help="number of data classes in the first task")
    ...
    parser.add_argument('--task_size', type=int, default=5, help='number of data classes each task')
    ...
    parser.add_argument('--epochs_global', type=int, default=200, help='total number of global rounds')
    parser.add_argument('--tasks_global', type=int, default=10, help='total number of tasks')
    parser.add_argument('--addclients', type=int, default=5, help='add')


    parser.add_argument('--a', type=float, default=0.5, help='the weight for loss_cur')
    parser.add_argument('--b', type=float, default=0.5, help='the weight for loss_old')
    ...
    parser.add_argument('--temperature', type=float, default=5.0, help='temperature of knowledge distilling')
